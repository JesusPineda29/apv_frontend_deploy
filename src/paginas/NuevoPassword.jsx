...
const NuevoPassword = () => {
  ...
  const [passwprdModificado, setPasswprdModificado] = useState(false)
  ...
  return (
    <>
      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        ...
        {passwprdModificado && <Link className="block text-center my-5 text-gray-500" to="/">Iniciar sesión</Link>}
      </div>
    </>
  )
};
