...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.pwd_nuevo.length < 6) {
      setAlerta({
        msg: 'El passwprd  debe tener mínimo 6 caracteres',
        error: true
      })
      return
    }
  ...
  return (
    <>
      ...
      <h2 className="font-black text-3xl text-center mt-10">Cambiar Pasword</h2>
        ...
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          >
            <div className="my-3">
              ...
              <input
                type="password"
                className="border border-gray-300 bg-gray-50 w-full p-2 mt-5 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300"
                name="pwd_actual"
